...
public class RobotMap {
  ...
  public static final int SHOOT_SOLENOID = 1, SHIFT_SOLENOID = 2, LITTLE_ENDGAME_SOLENOID_1 = 3, LITTLE_ENDGAME_SOLENOID_2 = 5, BIG_ENDGAME_SOLENOID_1 = 4, BIG_ENDGAME_SOLENOID_2 = 6;
