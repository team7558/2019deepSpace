...
<html>
   <head>
      <link rel="stylesheet" type="text/css" href="css/scoutingappstyle.css">
   ...
   <body>
      ...
      <div id="gameinfo">
         <div class="inputlower"></div>
         <span class="competitiontitle">Competition ID:</span><?php echo $cid; ?><br>
         <div class="inputmid"></div>
         <span class="competitiontitle">Match Number:</span><span id="matchnumber"><input type="number" min=0 max=500 id="inputmatchnumber" onchange="updateMatchNumber();"></span><br>
      </div>
      <div id="teaminfo">
          <div class="inputlower"></div>
         ...
         <div id="playfieldrow">
            ...
            <div id="gamearea">
                <div id="miscellaneous">
                     ...
                     <!--Endgame Info-->
                     <input type="hidden" id="datarobotscarried" name="RobotsCarried" value="false">
                     ...
                     <input type="hidden" id="matchdatascoutname" name="ScoutName" value="">
